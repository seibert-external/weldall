...
Die CLI unterstützt Linux und macOS und benötigt Node.js 22.15 oder neuer. Native-YAML-IaC-Befehle laufen auf beiden Plattformen; interaktive Benutzersitzungen verwenden den macOS-Schlüsselbund.

...
Für diese CLI-Anmeldung benötigt der Mitarbeiter vorher eine direkte `weldall:login`-Zuweisung. Die Browser-Anmeldung an der Weldall-Administrationsoberfläche ist davon getrennt.

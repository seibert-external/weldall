...
Standalone binaries require no Node.js, npm, or Bun. The macOS binaries are signed with a Seibert Developer ID certificate and notarized by Apple. Linux and Windows binaries are not signed yet. We are working on it.

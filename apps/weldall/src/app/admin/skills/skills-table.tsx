          ...
          <div className="grid justify-items-start gap-1">
            {row.original.source.type === "manual" ? (
              ...
              <div onClick={(event) => event.stopPropagation()}>
                <Button
                  href={`/admin/resources/${row.original.source.resourceId}`}
      ...
      <HerocrumbsActions>
        <div className="admin-table-action-row">
          ...
          <Selector
            ...
            width={220}
          />
          <Button href="/admin/skills/new" label="Create skill" variant="primary" />
        </div>
      </HerocrumbsActions>
            ...
            >
              ...
              <TableBody>
                {table.getRowModel().rows.map((row) => {
                  const href = `/admin/skills/${row.original.id}`;
                  return (
                    <TableRow
                      key={row.id}

...
- For CLI syntax, read `apps/cli/src/commands.ts` and validate the built interface with `./apps/cli/dist/index.js <command> --help`; request payload behavior is covered in `apps/cli/test/transfers.test.ts`.

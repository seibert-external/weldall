...
required_variables="POSTGRES_URL WELDALL_ISSUER BETTER_AUTH_SECRET WELDALL_CREDENTIAL_ENCRYPTION_KEY WELDALL_SIGNING_PRIVATE_JWK WELDALL_SIGNING_PUBLIC_JWK WELDALL_SIGNING_KID"

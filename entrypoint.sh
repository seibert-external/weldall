...
required_variables="POSTGRES_URL WELDALL_ISSUER BETTER_AUTH_SECRET WELDALL_TRUSTED_PROXY_SECRET GOOGLE_CLIENT_ID GOOGLE_CLIENT_SECRET WELDALL_SIGNING_PRIVATE_JWK WELDALL_SIGNING_PUBLIC_JWK WELDALL_SIGNING_KID"
